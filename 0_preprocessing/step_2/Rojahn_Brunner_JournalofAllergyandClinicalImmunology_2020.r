...
# IO - Setting
#
py$output_dir = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/data_preparation_HCA_v1_0/Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020"
py_run_string("os.makedirs(output_dir, exist_ok=True)")
h5ad_ALL_file = "GSE153760_ALL.h5ad"
metadata_ALL_file = "GSE153760_ALL_metadata.tsv"
h5ad_HC_file = "GSE153760_HC.h5ad"
metadata_HC_file = "GSE153760_HC_metadata.tsv"
######
input_folder = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020/GSE153760_RAW"
...
# Metadata
#
HCA_metadata_list = load_HCA_metadata_xlsx("D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/HCA_metadata/Rojahn_2020_HCA_tier 1_metadata.xlsx")
...
#
### Study level
py$adata$obs["study_id"] = "Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020"
### Experiment level
...
py$adata$obs["disease_status"] = dplyr::case_when(
  grepl("HC", sample_id_running_c, fixed = T) ~ "not applicable",
...
### Previous Barcode
this_dataset_individual = "Rojahn 2020"
this_dataset_integrated = "Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020"
