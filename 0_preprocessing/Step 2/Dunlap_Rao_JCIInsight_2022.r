...
# IO - Setting
#
py$output_dir = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/data_preparation_HCA_v1_0/Dunlap_Rao_JCIInsight_2022"
py_run_string("os.makedirs(output_dir, exist_ok=True)")
h5ad_ALL_file = "GSE186476_ALL.h5ad"
metadata_ALL_file = "GSE186476_ALL_metadata.tsv"
h5ad_HC_file = "GSE186476_HC.h5ad"
metadata_HC_file = "GSE186476_HC_metadata.tsv"
######
input_folder = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/Dunlap_Rao_JCIInsight_2022/GSE186476_RAW"
sample_unique = gsub(pattern = "_counts.tar.gz", "", sapply(list.files(input_folder, pattern = ".tar.gz"), function(x){
  paste(unlist(strsplit(x, "_", fixed = T))[-1], collapse = "_")
}))
sample_id_running_c = c()
py_run_string("GEX_dict = {}")
for(this_sample in sample_unique){
  ReadMtx_py("tmp_adata", data_dir = paste0(input_folder, "/", this_sample, "_counts"), prefix = "", feature_column_name = c("gene_ids", "feature_name", "feature_types"))
...
# Metadata
#
HCA_metadata_list = load_HCA_metadata_xlsx("D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/HCA_metadata/Dunlap_2022_HCA_tier 1_metadata.xlsx")
...
rownames(HCA_metadata_list$SP) = c("Healthy_D01", "Healthy_D02", "Healthy_D03", "Healthy_D04", "Healthy_D05", "Healthy_D06", "Healthy_D07", "Healthy_D08", "Healthy_D09", "Healthy_D10", "Healthy_D11", "Healthy_D12", "Healthy_D13", "Healthy_D14", "Lupus-Les_D1", "Lupus-Les_D2", "Lupus-Les_D3", "Lupus-Les_D4", "Lupus-Les_D5", "Lupus-Les_D6", "Lupus-Les_D7", "Lupus-NonLes_D1", "Lupus-NonLes_D2", "Lupus-NonLes_D3", "Lupus-NonLes_D4", "Lupus-NonLes_D5", "Lupus-NonLes_D6", "Lupus-NonLes_D7")
HCA_metadata_list$SP[is.na(HCA_metadata_list$SP)] = "unknown"
#
donor_id_c = HCA_metadata_list$SP[sample_id_running_c, "donor_id"]
# Sex Identification
...
#
### Study level
py$adata$obs["study_id"] = "Dunlap_Rao_JCIInsight_2022"
### Experiment level
...
py$adata$obs["donor_id_running"] = paste0(py$adata$obs[["experiment_id"]], "___", dplyr::case_match(
  sample_id_running_c,
  "Healthy_D01" ~ "Healthy_D01",
  "Healthy_D02" ~ "Healthy_D02",
  "Healthy_D03" ~ "Healthy_D03",
  "Healthy_D04" ~ "Healthy_D04",
  "Healthy_D05" ~ "Healthy_D05",
  "Healthy_D06" ~ "Healthy_D06",
  "Healthy_D07" ~ "Healthy_D07",
  "Healthy_D08" ~ "Healthy_D08",
  "Healthy_D09" ~ "Healthy_D09",
  "Healthy_D10" ~ "Healthy_D10",
  "Healthy_D11" ~ "Healthy_D11",
  "Healthy_D12" ~ "Healthy_D12",
  "Healthy_D13" ~ "Healthy_D13",
  "Healthy_D14" ~ "Healthy_D14",
  "Lupus-Les_D1" ~ "CL1",
  "Lupus-Les_D2" ~ "CL2",
  "Lupus-Les_D3" ~ "CL3",
  "Lupus-Les_D4" ~ "CL4",
...
py$adata$obs["disease"] = dplyr::case_match(
  ...
  "Healthy_D13" ~ "normal",
  "Healthy_D14" ~ "normal",
  "Lupus-Les_D1" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-Les_D2" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-Les_D3" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-Les_D4" ~ "discoid lupus erythematosus",
  "Lupus-Les_D5" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-Les_D6" ~ "discoid lupus erythematosus",
  "Lupus-Les_D7" ~ "discoid lupus erythematosus",
  "Lupus-NonLes_D1" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-NonLes_D2" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-NonLes_D3" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-NonLes_D4" ~ "discoid lupus erythematosus",
  "Lupus-NonLes_D5" ~ "subacute cutaneous lupus erythematosus",
  "Lupus-NonLes_D6" ~ "discoid lupus erythematosus",
  "Lupus-NonLes_D7" ~ "discoid lupus erythematosus",
  .default = sample_id_running_c
)
...
py$adata$obs["disease_status"] = dplyr::case_match(
  sample_id_running_c,
  "Healthy_D01" ~ "not applicable",
  "Healthy_D02" ~ "not applicable",
  "Healthy_D03" ~ "not applicable",
  "Healthy_D04" ~ "not applicable",
  "Healthy_D05" ~ "not applicable",
  "Healthy_D06" ~ "not applicable",
  "Healthy_D07" ~ "not applicable",
  "Healthy_D08" ~ "not applicable",
  "Healthy_D09" ~ "not applicable",
  "Healthy_D10" ~ "not applicable",
  "Healthy_D11" ~ "not applicable",
  "Healthy_D12" ~ "not applicable",
  "Healthy_D13" ~ "not applicable",
  "Healthy_D14" ~ "not applicable",
  "Lupus-Les_D1" ~ "unknown",
  "Lupus-Les_D2" ~ "unknown",
  "Lupus-Les_D3" ~ "unknown",
  "Lupus-Les_D4" ~ "unknown",
  "Lupus-Les_D5" ~ "unknown",
  "Lupus-Les_D6" ~ "unknown",
  "Lupus-Les_D7" ~ "unknown",
  "Lupus-NonLes_D1" ~ "unknown",
  "Lupus-NonLes_D2" ~ "unknown",
  "Lupus-NonLes_D3" ~ "unknown",
  "Lupus-NonLes_D4" ~ "unknown",
  "Lupus-NonLes_D5" ~ "unknown",
  "Lupus-NonLes_D6" ~ "unknown",
  "Lupus-NonLes_D7" ~ "unknown",
  .default = sample_id_running_c
)
...
### Previous Barcode
this_dataset_individual = "Dunlap 2022"
this_dataset_integrated = "Dunlap_Rao_JCIInsight_2022"
individual_barcode_used = rownames(IndividualAnalysis_metadata_list[[this_dataset_individual]])
names(individual_barcode_used) = gsub("___", "___Healthy_", sapply(paste0(IndividualAnalysis_metadata_list[[this_dataset_individual]][, "SampleID"], "_", rownames(IndividualAnalysis_metadata_list[[this_dataset_individual]])), function(x){
...
names(integrated_barcode_used) = gsub("___", "___Healthy_", sapply(paste0(IntegratedAnnotation_2_metadata[integrated_barcode_used, "SampleID"], "_", sapply(integrated_barcode_used, function(x){
  str_fragments = unlist(strsplit(x, "---", fixed = T))
  return(str_fragments[-length(str_fragments)])
})), function(x){
  str_fragments = unlist(strsplit(x, ".", fixed = T))
