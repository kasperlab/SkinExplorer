...
# IO - Setting
#
py$output_dir = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/data_preparation_HCA_v1_0/Wang_Atwood_NatureCommunications_2020"
py_run_string("os.makedirs(output_dir, exist_ok=True)")
h5ad_ALL_file = "GSE147482_ALL.h5ad"
metadata_ALL_file = "GSE147482_ALL_metadata.tsv"
######
input_folder = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/Wang_Atwood_NatureCommunications_2020/GSE147482_RAW"
...
for(this_prefix in prefix_unique){
  ...
  ReadMtx_py("tmp_adata", data_dir = input_folder, prefix = paste0(this_prefix, "_"), features="genes", feature_column_name = c("gene_ids", "feature_name"))
...
# Metadata
#
HCA_metadata_list = load_HCA_metadata_xlsx("D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/HCA_metadata/Wang_2020_HCA_tier 1_metadata.xlsx")
...
#
### Study level
py$adata$obs["study_id"] = "Wang_Atwood_NatureCommunications_2020"
### Experiment level
...
py$adata$obs["anatomical_region_level_2"] = "Genitalia"
py$adata$obs["anatomical_region_level_3"] = "Foreskin"
...
### Previous Barcode
this_dataset_individual = "Wang 2020"
this_dataset_integrated = "Wang_Atwood_NatureCommunications_2020"
