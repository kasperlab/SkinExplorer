...
# IO - Setting
#
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Skin/Human/data_preparation_HCA_v1_0/Zou_Liu_DevelopmentalCell_2020"
...
######
input_folder = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Zou_Liu_DevelopmentalCell_2020"
sample_id_c = c()
...
#
### Study level
py$adata$obs["study_id"] = "Zou_Liu_DevelopmentalCell_2020"
### Experiment level
...
individual_barcode_all = individual_barcode_used[stringi::stri_replace_all_fixed(str = paste0(py$adata$obs[["study_id"]], "___", py$adata$obs_names$values),
                                                                                 pattern = c("HRS118996", "HRS118997", "HRS118998", "HRS118999", "HRS119000", "HRS119001", "HRS119002", "HRS119003", "HRS119004"),
                                                                                 replacement = c("Skin-Y-18", "Skin-Y-22", "Skin-Y-23", "Skin-M-44", "Skin-M-47", "Skin-M-48", "Skin-O-70", "Skin-O-73", "Skin-O-76"),
                                                                                 vectorize_all = FALSE)]
