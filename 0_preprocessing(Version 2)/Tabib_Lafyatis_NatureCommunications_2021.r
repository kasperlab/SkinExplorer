...
# IO - Setting
#
py$output_dir = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/data_preparation_HCA_v1_0/Tabib_Lafyatis_NatureCommunications_2021"
py_run_string("os.makedirs(output_dir, exist_ok=True)")
h5ad_ALL_file = "GSE138669_ALL.h5ad"
metadata_ALL_file = "GSE138669_ALL_metadata.tsv"
h5ad_HC_file = "GSE138669_HC.h5ad"
metadata_HC_file = "GSE138669_HC_metadata.tsv"
######
input_folder = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/Tabib_Lafyatis_NatureCommunications_2021/GSE138669_RAW"
prefix_unique = sapply(list.files(input_folder, pattern = "raw_feature_bc_matrix.h5"), function(x){
  str_fragments = unlist(strsplit(x, "raw_", fixed = T))
...
for(this_prefix in prefix_unique){
  ...
  py_run_string(paste0("tmp_adata = sc.read_10x_h5('", input_folder, "/", this_prefix, "raw_feature_bc_matrix.h5')"))
  py_run_string(paste0("tmp_adata.obs_names = '", this_sample, "_' + tmp_adata.obs_names.astype(str).values"))
  py_run_string(paste0("tmp_adata.var['feature_name'] = tmp_adata.var_names.values.copy()"))
  py_run_string(paste0("tmp_adata.var_names = tmp_adata.var['gene_ids'].copy()"))
...
# Metadata
#
Tabib_Lafyatis_JournalofInvestigativeDermatology_2017_metadata_path = "D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/Tabib_Lafyatis_JournalofInvestigativeDermatology_2017/Skin_6Control_Metadata/Skin_6Control_Metadata.csv"
metadata_raw = as.matrix(read.table(Tabib_Lafyatis_JournalofInvestigativeDermatology_2017_metadata_path, header = T, row.names = 1, sep = ","))
rownames(metadata_raw) = sapply(rownames(metadata_raw), function(x){
  str_fragments = unlist(strsplit(x, "control_"))
  return(paste0(str_fragments[1], "_", gsub(".", "-", str_fragments[2], fixed = T)))
})
metadata_clustering_060_c = gsub(" ", "", as.character(metadata_raw[, "res.0.6"][py$adata$obs_names$values]))
metadata_clustering_060_c[is.na(metadata_clustering_060_c)] = "unknown"
author_cell_type_1 = dplyr::case_match(
  metadata_clustering_060_c,
  "0" ~ "Fibroblast_0",
  "1" ~ "Keratinocyte_1",
  "2" ~ "EndothelialCell_2",
  "3" ~ "Fibroblast_3",
  ...
  "17" ~ "CornifiedEnv_17",
  "18" ~ "BCell_18",
  .default = metadata_clustering_060_c
)
rm(metadata_raw)
#
HCA_metadata_list = load_HCA_metadata_xlsx("D:/Study/KI/Projects/###/MetaStudies/Data/Skin/Human/HCA_metadata/Tabib_2021_HCA_tier 1_metadata.xlsx")
...
rownames(HCA_metadata_list$SP) = HCA_metadata_list$SP[, "donor_id"]
...
#
### Study level
py$adata$obs["study_id"] = "Tabib_Lafyatis_NatureCommunications_2021"
### Experiment level
...
py$adata$obs["ethnicity_1"] = dplyr::case_match(
  sample_id_running_c,
  "SC1" ~ "European Ancestry",
  "SC4" ~ "European Ancestry",
  "SC18" ~ "European Ancestry",
  "SC32" ~ "Asian ancestry",
  "SC33" ~ "European Ancestry",
  "SC34" ~ "European Ancestry",
  "SC50" ~ "European Ancestry",
  "SC68" ~ "European Ancestry",
  "SC124" ~ "European Ancestry",
  "SC125" ~ "African Ancestry",
  "SC2" ~ "European Ancestry",
  "SC5" ~ "European Ancestry",
  "SC19" ~ "European Ancestry",
  "SC49" ~ "European Ancestry",
  "SC60" ~ "unknown",
  "SC69" ~ "European Ancestry",
  "SC70" ~ "European Ancestry",
  "SC86" ~ "European Ancestry",
  "SC119" ~ "African Ancestry",
  "SC185" ~ "European Ancestry",
  "SC188" ~ "European Ancestry",
  "SC189" ~ "European Ancestry",
...
py$adata$obs["disease"] = dplyr::case_match(
  ...
  "SC124" ~ "normal",
  "SC125" ~ "normal",
  "SC2" ~ "diffuse cutaneous systemic sclerosis",
  "SC5" ~ "diffuse cutaneous systemic sclerosis",
  "SC19" ~ "diffuse cutaneous systemic sclerosis",
  "SC49" ~ "diffuse cutaneous systemic sclerosis",
  "SC60" ~ "diffuse cutaneous systemic sclerosis",
  "SC69" ~ "diffuse cutaneous systemic sclerosis",
  "SC70" ~ "diffuse cutaneous systemic sclerosis",
  "SC86" ~ "diffuse cutaneous systemic sclerosis",
  "SC119" ~ "diffuse cutaneous systemic sclerosis",
  "SC185" ~ "diffuse cutaneous systemic sclerosis",
  "SC188" ~ "diffuse cutaneous systemic sclerosis",
  "SC189" ~ "diffuse cutaneous systemic sclerosis",
  .default = sample_id_running_c
)
...
py$adata$obs["disease_status"] = dplyr::case_match(
  ...
  "SC50" ~ "not applicable",
  "SC68" ~ "not applicable",
  "SC124" ~ "not applicable",
  "SC125" ~ "not applicable",
  "SC2" ~ "unknown",
  "SC5" ~ "unknown",
  "SC19" ~ "unknown",
  "SC49" ~ "unknown",
...
py$adata$obs["anatomical_region_level_2"] = "Arm"
py$adata$obs["anatomical_region_level_3"] = "Forearm"
...
### Previous Barcode
this_dataset_individual = "Tabib 2021"
this_dataset_integrated = "Tabib_Lafyatis_NatureCommunications_2021"
individual_barcode_used = rownames(IndividualAnalysis_metadata_list[[this_dataset_individual]])
names(individual_barcode_used) = sapply(individual_barcode_used, function(x){
