...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Ji_Khavari_Cell_2020/convert_output/GSE151091_raw_matrix.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Ji_Khavari_Cell_2020/convert_output/GSE151091_raw_matrix_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Ji_Khavari_Cell_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Ji_Khavari_Cell_2020/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2', 'AnatomicalRegionLevel3', 'Age', 'Sex']") # We use shorter DonorIDs in each separate analysis
######
...
if(do_DEG){
  ...
  for(ii in c("leiden_1_020", "leiden_1_300")){
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  ######
  #
  cell_annotation[leiden_1_020 == "0"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "2"] = "Myeloid Cell"
  cell_annotation[leiden_1_020 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "4"] = "Myeloid Cell"
  cell_annotation[leiden_1_020 == "5"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "6"] = "Lymphocyte"
  cell_annotation[leiden_1_020 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "8"] = "Melanocyte"
  cell_annotation[leiden_1_020 == "9"] = "Unknown"
  cell_annotation[leiden_1_020 == "10"] = "Fibroblast"
  cell_annotation[leiden_1_020 == "11"] = "Myeloid Cell"
  cell_annotation[leiden_1_020 == "12"] = "Keratinocyte"
  #
  cell_annotation[leiden_1_300 == "37"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_300 == "40"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_300 == "42"] = "Mural Cell"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_IntegratedAnnotation_1_leiden_1_020'].astype(str).values")
  }
  ###
