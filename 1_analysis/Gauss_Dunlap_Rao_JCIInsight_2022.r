...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Dunlap_Rao_JCIInsight_2022/convert_output/GSE186476_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Dunlap_Rao_JCIInsight_2022/convert_output/GSE186476_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Dunlap_Rao_JCIInsight_2022/ALL/v11_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Dunlap_Rao_JCIInsight_2022/ALL/v11_gauss"
...
py_run_string("factors = ['DonorID_short', 'Sex', 'SampleID']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# The remaining cells were then filtered to only include cells with between 200 and 3500 detected features and those with less than 15% of reads associated with mitochondrial genes.
filter =
  py$adata$obs["pct_counts_mt"] < 15 &
  py$adata$obs["n_genes_by_counts"] >= 200 &
  py$adata$obs["n_genes_by_counts"] <= 3500
print(sum(filter))
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  cell_annotation[leiden_1_020 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "2"] = "Lymphocyte"
  cell_annotation[leiden_1_020 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "4"] = "Mural Cell"
  cell_annotation[leiden_1_020 == "5"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_020 == "6"] = "Melanocyte"
  cell_annotation[leiden_1_020 == "7"] = "Myeloid Cell"
  cell_annotation[leiden_1_020 == "8"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_020 == "9"] = "Schwann Cell"
  cell_annotation[leiden_1_020 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "11"] = "Mast Cell"
  cell_annotation[leiden_1_020 == "12"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "14"] = "Fibroblast"
  cell_annotation[leiden_1_020 == "15"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "16"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "17"] = "MIX - KC/MUR"
  #
