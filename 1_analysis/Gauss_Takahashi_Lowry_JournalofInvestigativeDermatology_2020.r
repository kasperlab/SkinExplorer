...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Takahashi_Lowry_JournalofInvestigativeDermatology_2020/convert_output/GSE129611.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Takahashi_Lowry_JournalofInvestigativeDermatology_2020/convert_output/GSE129611_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Takahashi_Lowry_JournalofInvestigativeDermatology_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Takahashi_Lowry_JournalofInvestigativeDermatology_2020/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'LibraryPlatform']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# Low-quality cells were filtered based on the following criteria: number of genes < 1,250 OR number of reads < 50,000.
filter =
  py$adata$obs["pct_counts_mt"] <= 5 &
...
if(do_DEG){
  ...
  for(ii in c("leiden_1_030", "leiden_1_300")){
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  cell_annotation[leiden_1_030 == "2"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "4"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "5"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "6"] = "Melanocyte"
  cell_annotation[leiden_1_030 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "8"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "9"] = "Lymphocyte"
  cell_annotation[leiden_1_030 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "11"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_030 == "12"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "14"] = "Fibroblast"
  cell_annotation[leiden_1_030 == "15"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "16"] = "Keratinocyte"
  #
  cell_annotation[leiden_1_300 == "38"] = "Mural Cell"
  #
