...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Rindler_Brunner_MolecularCancer_2021/convert_output/GSE173205_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Rindler_Brunner_MolecularCancer_2021/convert_output/GSE173205_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Rindler_Brunner_MolecularCancer_2021/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Rindler_Brunner_MolecularCancer_2021/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Age', 'Sex']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# Additional filtering steps were carried out discarding cells with high mitochondrial content and very low or very high numbers of expressed genes.
# No actual parameters provided in the paper...
filter =
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_020'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  cell_annotation = rep(NA, py$adata_imbalance$n_obs)
  names(cell_annotation) = py$cell_sorting
  leiden_1_020 = as.character(py$adata_imbalance$obs[['leiden_1_020']])
  leiden_1_300 = as.character(py$adata_imbalance$obs[['leiden_1_300']])
  ######
  #
  cell_annotation[leiden_1_020 == "0"] = "Fibroblast"
  cell_annotation[leiden_1_020 == "1"] = "Fibroblast"
  cell_annotation[leiden_1_020 == "2"] = "Lymphocyte"
  cell_annotation[leiden_1_020 == "3"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_020 == "4"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_020 == "5"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_020 == "6"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "7"] = "Melanocyte"
  cell_annotation[leiden_1_020 == "8"] = "Mural Cell"
  cell_annotation[leiden_1_020 == "9"] = "Myeloid Cell"
  cell_annotation[leiden_1_020 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "12"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "14"] = "Schwann Cell"
  cell_annotation[leiden_1_020 == "15"] = "Mural Cell"
  #
  cell_annotation[leiden_1_300 == "46"] = "Erythrocyte"
  cell_annotation[leiden_1_300 == "52"] = "Mast Cell"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_020'].astype(str).values")
  }
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_020']")
