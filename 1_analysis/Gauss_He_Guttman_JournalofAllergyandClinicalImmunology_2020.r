...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/He_Guttman_JournalofAllergyandClinicalImmunology_2020/convert_output/GSE147424_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/He_Guttman_JournalofAllergyandClinicalImmunology_2020/convert_output/GSE147424_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/He_Guttman_JournalofAllergyandClinicalImmunology_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/He_Guttman_JournalofAllergyandClinicalImmunology_2020/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Sex', 'SampleStatus']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# Cells with fewer than 100 genes, more than 5000 genes, or more than 25% mitochondria content were excluded.
filter =
  py$adata$obs["pct_counts_mt"] <= 25 &
  py$adata$obs["n_genes_by_counts"] >= 100 &
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  ######
  #
  cell_annotation[leiden_1_020 == "0"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_020 == "1"] = "Fibroblast"
  cell_annotation[leiden_1_020 == "2"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "4"] = "Mural Cell"
  cell_annotation[leiden_1_020 == "5"] = "Lymphocyte"
  cell_annotation[leiden_1_020 == "6"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "7"] = "Myeloid Cell"
  cell_annotation[leiden_1_020 == "8"] = "Keratinocyte"
  cell_annotation[leiden_1_020 == "9"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_020 == "10"] = "Melanocyte"
  cell_annotation[leiden_1_020 == "11"] = "Schwann Cell"
  #
