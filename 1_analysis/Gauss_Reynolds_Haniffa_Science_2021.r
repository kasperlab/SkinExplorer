...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Reynolds_Haniffa_Science_2021/convert_output/healthy.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Reynolds_Haniffa_Science_2021/convert_output/healthy_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Reynolds_Haniffa_Science_2021/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Reynolds_Haniffa_Science_2021/ALL/v10_gauss"
...
######
py_run_string("merge_by = ['DonorID', 'SampleID']")
...
py_run_string("factors = ['DonorID_short', 'SampleID', 'Tissue', 'CellEnrichment', 'CellCondition']") # We use shorter DonorIDs in each separate analysis
######
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  leiden_1_050 = as.character(py$adata_imbalance$obs[['leiden_1_050']])
  leiden_1_300 = as.character(py$adata_imbalance$obs[['leiden_1_300']])
  ######
  #
  cell_annotation[leiden_1_050 == "0"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_050 == "1"] = "Lymphocyte"
  cell_annotation[leiden_1_050 == "2"] = "Myeloid Cell"
  cell_annotation[leiden_1_050 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "4"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "5"] = "Fibroblast"
  cell_annotation[leiden_1_050 == "6"] = "Lymphocyte"
  cell_annotation[leiden_1_050 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "8"] = "Myeloid Cell"
  cell_annotation[leiden_1_050 == "9"] = "Myeloid Cell"
  cell_annotation[leiden_1_050 == "10"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_050 == "11"] = "Lymphocyte"
  cell_annotation[leiden_1_050 == "12"] = "Mural Cell"
  cell_annotation[leiden_1_050 == "13"] = "Melanocyte"
  cell_annotation[leiden_1_050 == "14"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "15"] = "Fibroblast"
  cell_annotation[leiden_1_050 == "16"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "17"] = "Mast Cell"
  cell_annotation[leiden_1_050 == "18"] = "Plasma"
  #
  cell_annotation[leiden_1_300 == "37"] = "Myeloid Cell + Keratinocyte"
  cell_annotation[leiden_1_300 == "42"] = "Lymphatic Endothelial Cell + Vascular Endothelial Cell"
  #
  #
  ...
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_IntegratedAnnotation_1_leiden_1_050'].astype(str).values")
  }
  ###
...
for(ii in c("phase", unlist(py$annotation))){
  py_run_string(paste0("clustering_plot(adata_imbalance, '", ii, "', basis='X_umap_imbalance', size=", get_dot_size(cell_number), ", ncols=5, save='_detail_", ii, ".pdf')"))
}
...
######
max_gene_number = 200
py$adata_imbalance$obsm['PCA_use'] = py$adata_imbalance_hvg$obsm['PCA_use']
adata_str = "adata_imbalance"
clustering_embedding = "PCA_use"
visualization_embedding = "X_umap_imbalance"
# DEG
DEG_keys = c("SeparateAnnotation_1")
for(DEG_key in DEG_keys){
  ...
  if(length(top_DEGs) <= max_gene_number){
    ...
    py_run_string(paste0("dot_fig = plot_dotplot_with_annotations(", adata_str, ", var_names=DEG_dict, groupby='", DEG_key, "', dendrogram=True, n_genes=10, swap_axes = False, highlight_genes = DEG_dict, highlight_params = {'facecolor': 'yellow', 'edgecolor': 'none', 'alpha': 0.5}, highlight_cluster_line = False, cluster_line_highlight_params = {'color': 'lightgreen', 'alpha': 0.2, 'zorder': -5},)"))
    py_run_string(paste0("dot_fig.savefig(f'{figure_dir}/dotplot_", adata_str, "_", DEG_key, ".pdf', bbox_inches = 'tight')"))
  }else{
    for(ii in 1:ceiling(length(top_DEGs) / max_gene_number)){
      ...
      py_run_string(paste0("dot_fig = plot_dotplot_with_annotations(", adata_str, ", var_names=tmp_genes_ordered, groupby='", DEG_key, "', dendrogram=True, n_genes=10, swap_axes = False, highlight_genes = DEG_dict, highlight_params = {'facecolor': 'yellow', 'edgecolor': 'none', 'alpha': 0.5}, highlight_cluster_line = False, cluster_line_highlight_params = {'color': 'lightgreen', 'alpha': 0.2, 'zorder': -5},)"))
      py_run_string(paste0("dot_fig.savefig(f'{figure_dir}/dotplot_", adata_str, "_", DEG_key, "_", ii, ".pdf', bbox_inches = 'tight')"))
      py_run_string("del tmp_genes")
    }
  }
}
py_run_string("marker_dict = {
  'Keratinocyte': ['KRT14', 'KRT15', 'KRT5', 'KRT1', 'KRT10', 'KRTDAP'],
  'Myeloid Cell': ['HLA-DRA', 'IL1B', 'LYZ', 'CD207'],
  'Plasma': ['JCHAIN', 'IGKC'],
  'Endothelial Cell': ['TM4SF1'],
  'Vascular Endothelial Cell': ['SELE', 'VWF', 'PECAM1'],
  'Lymphatic Endothelial Cell': ['LYVE1', 'CCL21', 'TFF3', 'MMRN1']
}")
DEG_key = "SeparateAnnotation_1"
...
py_run_string(paste0("dot_fig.savefig(f'{figure_dir}/dotplot_", adata_str, "_", DEG_key, "_marker_dict_var.pdf', bbox_inches = 'tight')"))

######
py_run_string(paste0("sc.pl.embedding(adata_imbalance, 'X_umap_imbalance', color=Keratinocyte_markers, layer='normalized', legend_loc='on data', legend_fontsize=6, size=", get_dot_size(cell_number), ", cmap=gene_highlight_cmap, ncols=6, frameon=False, save='_Signatures_Keratinocyte_GHC.pdf')"))
py_run_string(paste0("sc.pl.embedding(adata_imbalance, 'X_umap_imbalance', color=Fibroblast_MuralCell_markers, layer='normalized', legend_loc='on data', legend_fontsize=6, size=", get_dot_size(cell_number), ", cmap=gene_highlight_cmap, ncols=4, frameon=False, save='_Signatures_Fibroblast_MuralCell_GHC.pdf')"))
py_run_string(paste0("sc.pl.embedding(adata_imbalance, 'X_umap_imbalance', color=NeuralCrestderivedCell_markers, layer='normalized', legend_loc='on data', legend_fontsize=6, size=", get_dot_size(cell_number), ", cmap=gene_highlight_cmap, ncols=4, frameon=False, save='_Signatures_NeuralCrestderivedCell_GHC.pdf')"))
py_run_string(paste0("sc.pl.embedding(adata_imbalance, 'X_umap_imbalance', color=EndothelialCell_markers, layer='normalized', legend_loc='on data', legend_fontsize=6, size=", get_dot_size(cell_number), ", cmap=gene_highlight_cmap, ncols=4, frameon=False, save='_Signatures_EndothelialCell_GHC.pdf')"))
py_run_string(paste0("sc.pl.embedding(adata_imbalance, 'X_umap_imbalance', color=ImmuneCell_markers, layer='normalized', legend_loc='on data', legend_fontsize=6, size=", get_dot_size(cell_number), ", cmap=gene_highlight_cmap, ncols=6, frameon=False, save='_Signatures_ImmuneCell_GHC.pdf')"))
py_run_string(paste0("sc.pl.embedding(adata_imbalance, 'X_umap_imbalance', color=Plasma_Erythrocyte_markers, layer='normalized', legend_loc='on data', legend_fontsize=6, size=", get_dot_size(cell_number), ", cmap=gene_highlight_cmap, ncols=4, frameon=False, save='_Signatures_Plasma_Erythrocyte_GHC.pdf')"))
