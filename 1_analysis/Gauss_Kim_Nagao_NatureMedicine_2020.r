...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Kim_Nagao_NatureMedicine_2020/convert_output/GSE132802_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Kim_Nagao_NatureMedicine_2020/convert_output/GSE132802_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Kim_Nagao_NatureMedicine_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Kim_Nagao_NatureMedicine_2020/ALL/v10_gauss"
...
######
py_run_string("merge_by = ['SampleID', 'LibraryPlatform']")
...
py_run_string("factors = ['DonorID_short', 'SampleID', 'Sex', 'LibraryPlatform', 'StrandSequence']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# criteria          MT nUMI_min nUMI_max  nGene_min nGene_max nCell_min_expressing_gene nCell_before  nCell_postfilter
# SKIN_HV1 (merged) 10 2000     25000     1000      4200      3                         3,069         2,685
# SKIN_HV2          10 2000     22500     1200      4000      3                         4,016         3,698
# SKIN_HV3          10 2000     25000     1000      4200      3                         4,923         4,790
# SKIN_HV4          10 2000     30000     1250      5000      3                         1,589         1,361
# SKIN_HV5          10 2000     30000     1300      5000      3                         1,165         1,008
filter =
  py$adata$obs["pct_counts_mt"] < 10 &
  py$adata$obs["n_genes_by_counts"] >= 1000 & 
  py$adata$obs["n_genes_by_counts"] <= 5000 & 
  py$adata$obs["total_counts"] >= 2000 & 
...
if(do_DEG){
  ...
  for(ii in c("leiden_1_010", "leiden_1_300")){
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_010'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  cell_annotation = rep(NA, py$adata_imbalance$n_obs)
  names(cell_annotation) = py$cell_sorting
  leiden_1_010 = as.character(py$adata_imbalance$obs[['leiden_1_010']])
  leiden_1_300 = as.character(py$adata_imbalance$obs[['leiden_1_300']])
  ######
  #
  cell_annotation[leiden_1_010 == "0"] = "Mural Cell"
  cell_annotation[leiden_1_010 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_010 == "2"] = "Fibroblast"
  cell_annotation[leiden_1_010 == "3"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_010 == "4"] = "Lymphocyte"
  cell_annotation[leiden_1_010 == "5"] = "Myeloid Cell"
  cell_annotation[leiden_1_010 == "6"] = "Fibroblast"
  cell_annotation[leiden_1_010 == "7"] = "Melanocyte"
  cell_annotation[leiden_1_010 == "8"] = "Keratinocyte"
  cell_annotation[leiden_1_010 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_010 == "10"] = "Fibroblast"
  cell_annotation[leiden_1_010 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_010 == "12"] = "Schwann Cell"
  cell_annotation[leiden_1_010 == "13"] = "Lymphatic Endothelial Cell"
  #
  cell_annotation[leiden_1_300 == "49"] = "Mural Cell"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_010'].astype(str).values")
  }
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_010']")
