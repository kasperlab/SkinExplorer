...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Theocharidis_Bhasin_NatureCommunications_2022/convert_output/GSE165816_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Theocharidis_Bhasin_NatureCommunications_2022/convert_output/GSE165816_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Theocharidis_Bhasin_NatureCommunications_2022/ALL/v11_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Theocharidis_Bhasin_NatureCommunications_2022/ALL/v11_gauss"
...
######
py_run_string("merge_by = ['DonorID']")
...
py_run_string("factors = ['DonorID_short', 'SampleID', 'Age', 'Sex', 'AnatomicalRegionLevel2', 'AnatomicalRegionLevel3', 'SampleType']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# The quality filtering on scRNASeq data was performed by multiple filtering parameters including >50% of mitochondrial genes, cells expressing the lower number of genes (<200 genes), and genes only uniquely expressed in <3 cells.
raw_counts = t(as(py$adata$X, "CsparseMatrix"))
dimnames(raw_counts) = list(py$adata$var_names$values, py$adata$obs_names$values)
raw_obj = CreateSeuratObject(raw_counts, min.cells = 3, min.features = 200)
filter =
  py$adata$obs_names$values %in% colnames(raw_obj) & # apply the first Seurat filtering
  py$adata$obs["pct_counts_mt"] <= 50 &
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  leiden_1_150 = as.character(py$adata_imbalance$obs[['leiden_1_150']])
  leiden_1_200 = as.character(py$adata_imbalance$obs[['leiden_1_200']])
  ######
  #
  cell_annotation[leiden_1_200 == "0"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "2"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "4"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "5"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "6"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "7"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_200 == "8"] = "Myeloid Cell"
  cell_annotation[leiden_1_200 == "9"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "11"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "12"] = "Lymphocyte"
  cell_annotation[leiden_1_200 == "13"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_200 == "14"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "15"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "16"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "17"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "18"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "19"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "20"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "21"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "22"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "23"] = "Mural Cell"
  cell_annotation[leiden_1_200 == "24"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "25"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_200 == "26"] = "Fibroblast"
  cell_annotation[leiden_1_200 == "27"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_200 == "28"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "29"] = "Melanocyte"
  cell_annotation[leiden_1_200 == "30"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_200 == "31"] = "Schwann Cell"
  cell_annotation[leiden_1_200 == "32"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "33"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "34"] = "Mast Cell"
  cell_annotation[leiden_1_200 == "35"] = "MIX - KC/MUR"
  cell_annotation[leiden_1_200 == "36"] = "MIX - KC/MUR"
  cell_annotation[leiden_1_200 == "37"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "38"] = "Schwann Cell"
  cell_annotation[leiden_1_200 == "39"] = "Lymphocyte"
  cell_annotation[leiden_1_200 == "40"] = "Keratinocyte"
  cell_annotation[leiden_1_200 == "41"] = "Myeloid Cell"
  cell_annotation[leiden_1_150 == "33"] = "MIX - KC/FIB"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_200'].astype(str).values")
  }
  ###
