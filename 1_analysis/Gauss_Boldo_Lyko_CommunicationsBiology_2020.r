...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Boldo_Lyko_CommunicationsBiology_2020/convert_output/GSE130973.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Boldo_Lyko_CommunicationsBiology_2020/convert_output/GSE130973_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Boldo_Lyko_CommunicationsBiology_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Boldo_Lyko_CommunicationsBiology_2020/ALL/v10_gauss"
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  ######
  #
  cell_annotation[leiden_1_010 == "0"] = "Fibroblast"
  cell_annotation[leiden_1_010 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_010 == "2"] = "Myeloid Cell"
  cell_annotation[leiden_1_010 == "3"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_010 == "4"] = "Lymphocyte"
  cell_annotation[leiden_1_010 == "5"] = "Mural Cell"
  cell_annotation[leiden_1_010 == "6"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_010 == "7"] = "Erythrocyte"
  cell_annotation[leiden_1_010 == "8"] = "Melanocyte"
  cell_annotation[leiden_1_010 == "9"] = "Plasma"
  #
  #
  ...
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_IntegratedAnnotation_1_leiden_1_010'].astype(str).values")
  }
  ###
