...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Cheng_Cho_CellReports_2018/convert_output/healthy.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Cheng_Cho_CellReports_2018/convert_output/healthy_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Cheng_Cho_CellReports_2018/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Cheng_Cho_CellReports_2018/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2', 'Sex']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# The filtering of its original paper is difficult to reproduce, we use an approximate criteria:
# Expressed gene number >= 1000 <= 6000, pct_counts_mt <= 10
filter =
  py$adata$obs["pct_counts_mt"] <= 10 &
  py$adata$obs["n_genes_by_counts"] >= 1000 &
  py$adata$obs["n_genes_by_counts"] <= 6000
print(sum(filter))
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_050'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  ...
  ######
  #
  cell_annotation[leiden_1_050 == "0"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "2"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "3"] = "Melanocyte"
  cell_annotation[leiden_1_050 == "4"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "5"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "6"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "8"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "10"] = "Myeloid Cell"
  cell_annotation[leiden_1_050 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "12"] = "Melanocyte"
  cell_annotation[leiden_1_050 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "14"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "15"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "16"] = "Keratinocyte"
  cell_annotation[leiden_1_050 == "17"] = "Lymphocyte"
  cell_annotation[leiden_1_050 == "18"] = "Erythrocyte"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_IntegratedAnnotation_1_leiden_1_005'].astype(str).values")
  }
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_050']")
