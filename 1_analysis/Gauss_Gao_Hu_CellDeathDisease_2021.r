...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Gao_Hu_CellDeathDisease_2021/convert_output/GSE162183_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Gao_Hu_CellDeathDisease_2021/convert_output/GSE162183_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Gao_Hu_CellDeathDisease_2021/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Gao_Hu_CellDeathDisease_2021/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Age', 'Sex', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# According to the evaluation of quality control, cells harboring <500 transcripts, <1000 unique molecules, >5% ratio of mitochondria, and predicted doublets were removed.
# Already filtered in the loom file
###
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_080'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  ...
  ######
  #
  cell_annotation[leiden_1_080 == "0"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_080 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "2"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "4"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "5"] = "Mural Cell"
  cell_annotation[leiden_1_080 == "6"] = "Mural Cell"
  cell_annotation[leiden_1_080 == "7"] = "Lymphocyte"
  cell_annotation[leiden_1_080 == "8"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "10"] = "Myeloid Cell"
  cell_annotation[leiden_1_080 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "12"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "13"] = "Mast Cell"
  cell_annotation[leiden_1_080 == "14"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "15"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_080 == "16"] = "Melanocyte"
  cell_annotation[leiden_1_080 == "17"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "18"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "19"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "20"] = "Mural Cell"
  cell_annotation[leiden_1_080 == "21"] = "Myeloid Cell"
  cell_annotation[leiden_1_080 == "22"] = "Schwann Cell"
  #
  ...
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_080']")
