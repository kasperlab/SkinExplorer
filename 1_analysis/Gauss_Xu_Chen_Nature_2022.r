...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Xu_Chen_Nature_2022/convert_output/OMIX691_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Xu_Chen_Nature_2022/convert_output/OMIX691_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Xu_Chen_Nature_2022/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Xu_Chen_Nature_2022/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Age', 'Sex', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2', 'AnatomicalRegionLevel3']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# For each of the 15 samples, we initially set up a first filter of min.cells = 3 and min.genes = 200 per sample.
# Cells with more than 5,000 genes or more than 25,000 unique molecular identifiers (UMIs) were removed.
# We kept cells with less than 1% mitochondrial gene expression.
...
filter =
  ...
  py$adata$obs["pct_counts_mt"] < 10 & # Only 230 cells left if we set 1, we set 10 now and 20174 cells left
  py$adata$obs["total_counts"] <= 25000 &
  py$adata$obs["n_genes_by_counts"] <= 5000
print(sum(filter))
rm(raw_counts)
rm(raw_obj)
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_030'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  cell_annotation = rep(NA, py$adata_imbalance$n_obs)
  names(cell_annotation) = py$cell_sorting
  leiden_1_030 = as.character(py$adata_imbalance$obs[['leiden_1_030']])
  leiden_1_300 = as.character(py$adata_imbalance$obs[['leiden_1_300']])
  ######
  #
  cell_annotation[leiden_1_030 == "0"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "2"] = "Melanocyte"
  cell_annotation[leiden_1_030 == "3"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "4"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "5"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "6"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "7"] = "Fibroblast"
  cell_annotation[leiden_1_030 == "8"] = "Lymphocyte"
  cell_annotation[leiden_1_030 == "9"] = "Mural Cell"
  cell_annotation[leiden_1_030 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "12"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_030 == "13"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "14"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "15"] = "Plasma"
  #
  cell_annotation[leiden_1_300 == "47"] = "Mast Cell"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_030'].astype(str).values")
  }
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_030']")
