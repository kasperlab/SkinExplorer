...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Wang_Atwood_NatureCommunications_2020/convert_output/GSE147482.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Wang_Atwood_NatureCommunications_2020/convert_output/GSE147482_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Wang_Atwood_NatureCommunications_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Wang_Atwood_NatureCommunications_2020/ALL/v10_gauss"
...
py$adata$obs["DonorID_short"] = sapply(as.character(py$adata$obs["DonorID"][, 1]), function(x){
  unlist(strsplit(x, split = "___", fixed = T))[2]
})
py_run_string("factors = ['DonorID_short']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# For downstream analyses, we kept cells which met the following filtering criteria per biological replicate per condition: >200 and <5000 genes/cell, and <10% mitochondrial gene expression.
filter =
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  cell_annotation[leiden_1_080 == "6"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "8"] = "Melanocyte"
  cell_annotation[leiden_1_080 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "12"] = "Myeloid Cell"
  cell_annotation[leiden_1_080 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "14"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_080 == "15"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_080 == "16"] = "Erythrocyte"
  #
