...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Wiedemann_Andersen_CellReports_2023/convert_output/GSE202352.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Wiedemann_Andersen_CellReports_2023/convert_output/GSE202352_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Wiedemann_Andersen_CellReports_2023/ALL/v11_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Wiedemann_Andersen_CellReports_2023/ALL/v11_gauss"
...
py_run_string("factors = ['DonorID_short', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2', 'AnatomicalRegionLevel3', 'Tissue', 'Sex', 'SampleID']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# For all datasets, cells with <300 and >4500 genes, and >20% mitochondrial genes detected were removed.
filter =
  py$adata$obs["pct_counts_mt"] <= 20 &
  py$adata$obs["n_genes_by_counts"] >= 300 &
  py$adata$obs["n_genes_by_counts"] <= 4500
print(sum(filter))
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  leiden_1_080 = as.character(py$adata_imbalance$obs[['leiden_1_080']])
  ######
  cell_annotation[leiden_1_080 == "0"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "2"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "4"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "5"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "6"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "7"] = "Mural Cell"
  cell_annotation[leiden_1_080 == "8"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "10"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_080 == "11"] = "Lymphocyte"
  cell_annotation[leiden_1_080 == "12"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "14"] = "Schwann Cell"
  cell_annotation[leiden_1_080 == "15"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "16"] = "Fibroblast"
  cell_annotation[leiden_1_080 == "17"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "18"] = "Keratinocyte"
  cell_annotation[leiden_1_080 == "19"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_080 == "20"] = "Mast Cell"
  cell_annotation[leiden_1_080 == "21"] = "Melanocyte"
  cell_annotation[leiden_1_080 == "22"] = "Myeloid Cell"
  cell_annotation[leiden_1_080 == "23"] = "Schwann Cell"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_080'].astype(str).values")
  }
  ###
