...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Boothby_Rosenblum_Nature_2021/convert_output/GSE183031_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Boothby_Rosenblum_Nature_2021/convert_output/GSE183031_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Boothby_Rosenblum_Nature_2021/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Boothby_Rosenblum_Nature_2021/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Age', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2', 'AnatomicalRegionLevel3']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# Cells with <200 features, >30,000 reads or >6% mitochondrial genes were filtered out during preprocessing.
filter =
  py$adata$obs["pct_counts_mt"] <= 6 &
  py$adata$obs["n_genes_by_counts"] >= 200 &
  py$adata$obs["total_counts"] <= 30000
print(sum(filter))
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_120'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  cell_annotation = rep(NA, py$adata_imbalance$n_obs)
  names(cell_annotation) = py$cell_sorting
  leiden_1_120 = as.character(py$adata_imbalance$obs[['leiden_1_120']])
  ######
  #
  cell_annotation[leiden_1_120 == "0"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "1"] = "Keratinocyte"
  cell_annotation[leiden_1_120 == "2"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "3"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "4"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "5"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "6"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "7"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "8"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "9"] = "Mural Cell"
  cell_annotation[leiden_1_120 == "10"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "11"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_120 == "12"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "13"] = "Mural Cell"
  cell_annotation[leiden_1_120 == "14"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_120 == "15"] = "Keratinocyte"
  cell_annotation[leiden_1_120 == "16"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "17"] = "Keratinocyte"
  cell_annotation[leiden_1_120 == "18"] = "Keratinocyte"
  cell_annotation[leiden_1_120 == "19"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_120 == "20"] = "Melanocyte"
  cell_annotation[leiden_1_120 == "21"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "22"] = "Lymphocyte"
  cell_annotation[leiden_1_120 == "23"] = "Fibroblast"
  cell_annotation[leiden_1_120 == "24"] = "Mast Cell"
  cell_annotation[leiden_1_120 == "25"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_120 == "26"] = "Mural Cell"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_120'].astype(str).values")
  }
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_120']")
