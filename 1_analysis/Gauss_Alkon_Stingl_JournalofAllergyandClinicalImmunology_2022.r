...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Alkon_Stingl_JournalofAllergyandClinicalImmunology_2022/convert_output/GSE180885_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Alkon_Stingl_JournalofAllergyandClinicalImmunology_2022/convert_output/GSE180885_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Alkon_Stingl_JournalofAllergyandClinicalImmunology_2022/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Alkon_Stingl_JournalofAllergyandClinicalImmunology_2022/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Sex', 'Age']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# Cells containing over 5000 n_genes_by_counts and over 10 % of mitochondrial genes were removed from the dataset.
filter =
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  ######
  #
  cell_annotation[leiden_1_100 == "0"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "1"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "2"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "3"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "4"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "5"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "6"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "7"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "8"] = "Lymphocyte"
  cell_annotation[leiden_1_100 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "10"] = "Plasma"
  cell_annotation[leiden_1_100 == "11"] = "Myeloid Cell"
  cell_annotation[leiden_1_100 == "12"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "13"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "14"] = "Melanocyte"
  #
  print(sum(is.na(cell_annotation)))
  py$tmp_clustering_result = cell_annotation
  ###
  if(use_altas_querying){
    py_run_string("tmp_clustering_result = adata_imbalance.obs['Spread_mapping_representative_SeparateAnnotation_1_leiden_1_100'].astype(str).values")
  }
  ###
