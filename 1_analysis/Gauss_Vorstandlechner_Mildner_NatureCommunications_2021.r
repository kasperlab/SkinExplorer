...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Vorstandlechner_Mildner_NatureCommunications_2021/convert_output/GSE156326_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Vorstandlechner_Mildner_NatureCommunications_2021/convert_output/GSE156326_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Vorstandlechner_Mildner_NatureCommunications_2021/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Vorstandlechner_Mildner_NatureCommunications_2021/ALL/v10_gauss"
...
# filtering
# From each sample, unwanted variations and low-quality cells were filtered by removing cells with high and low (>3000 and <200) unique molecular identifier (UMI)-counts.
filter =
  py$adata$obs["n_genes_by_counts"] >= 200 &
  py$adata$obs["n_genes_by_counts"] <= 3000
print(sum(filter))
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  cell_annotation[leiden_1_015 == "2"] = "Myeloid Cell"
  cell_annotation[leiden_1_015 == "3"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_015 == "4"] = "Mural Cell"
  cell_annotation[leiden_1_015 == "5"] = "Lymphocyte"
  cell_annotation[leiden_1_015 == "6"] = "Melanocyte"
  cell_annotation[leiden_1_015 == "7"] = "Lymphatic Endothelial Cell"
  #
