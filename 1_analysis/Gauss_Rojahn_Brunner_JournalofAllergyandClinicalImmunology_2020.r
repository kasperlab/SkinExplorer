...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020/convert_output/GSE153760_HC.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020/convert_output/GSE153760_HC_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Rojahn_Brunner_JournalofAllergyandClinicalImmunology_2020/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'Age', 'Sex', 'LibraryPlatform', 'SampleType']") # We use shorter DonorIDs in each separate analysis
######
...
# filtering
# Cells with low (<500) unique molecular identifier counts were excluded from the dataset.
filter =
  py$adata$obs["n_genes_by_counts"] >= 500
print(sum(filter))
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  cell_annotation[leiden_1_030 == "1"] = "Lymphocyte"
  cell_annotation[leiden_1_030 == "2"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "4"] = "Fibroblast"
  cell_annotation[leiden_1_030 == "5"] = "Fibroblast"
  cell_annotation[leiden_1_030 == "6"] = "Melanocyte"
  cell_annotation[leiden_1_030 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "8"] = "Vascular Endothelial Cell"
  cell_annotation[leiden_1_030 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "10"] = "Mural Cell"
  cell_annotation[leiden_1_030 == "11"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "12"] = "Lymphocyte"
  cell_annotation[leiden_1_030 == "13"] = "Lymphatic Endothelial Cell"
  cell_annotation[leiden_1_030 == "14"] = "Mast Cell"
  cell_annotation[leiden_1_030 == "15"] = "Keratinocyte"
  cell_annotation[leiden_1_030 == "16"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "17"] = "Myeloid Cell"
  cell_annotation[leiden_1_030 == "18"] = "Plasma"
  #
