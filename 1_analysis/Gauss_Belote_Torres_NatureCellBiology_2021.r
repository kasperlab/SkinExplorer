...
######
######
loom_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Belote_Torres_NatureCellBiology_2021/convert_output/GSE151091_raw_matrix.loom"
metadata_path = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Data/Belote_Torres_NatureCellBiology_2021/convert_output/GSE151091_raw_matrix_metadata.tsv"
######
...
######
py$output_dir = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Belote_Torres_NatureCellBiology_2021/ALL/v10_gauss"
py$output_dir_cache = "/home/haoy/projects/MetaStudiesAnalysis/Integration/Output/Belote_Torres_NatureCellBiology_2021/ALL/v10_gauss"
...
py_run_string("factors = ['DonorID_short', 'AnatomicalRegionLevel1', 'AnatomicalRegionLevel2', 'AnatomicalRegionLevel3', 'Age', 'Sex', 'Ethnicity1']") # We use shorter DonorIDs in each separate analysis
######
...
filter =
  py$adata$obs["n_genes_by_counts"] >= 1250 &
  py$adata$obs["total_counts"] >= 50000
print(sum(filter))
...
if(do_DEG){
  ...
  for(ii in c("leiden_1_100", "leiden_1_300")){
...
if(file.exists(adata_imbalance_annotated_1_path)){
  ...
  py_run_string("tmp_leiden_all = adata_imbalance.obs['leiden_1_100'][cell_sorting].astype(str).values")
  leiden_all = py$tmp_leiden_all
  py_run_string("del tmp_leiden_all")
  cell_annotation = rep(NA, py$adata_imbalance$n_obs)
  names(cell_annotation) = py$cell_sorting
  leiden_1_100 = as.character(py$adata_imbalance$obs[['leiden_1_100']])
  leiden_1_300 = as.character(py$adata_imbalance$obs[['leiden_1_300']])
  ######
  #
  cell_annotation[leiden_1_100 == "0"] = "Melanocyte"
  cell_annotation[leiden_1_100 == "1"] = "Melanocyte"
  cell_annotation[leiden_1_100 == "2"] = "Melanocyte"
  cell_annotation[leiden_1_100 == "3"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "4"] = "Melanocyte"
  cell_annotation[leiden_1_100 == "5"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "6"] = "Melanocyte"
  cell_annotation[leiden_1_100 == "7"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "8"] = "Melanocyte"
  cell_annotation[leiden_1_100 == "9"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "10"] = "Keratinocyte"
  cell_annotation[leiden_1_100 == "11"] = "Myeloid Cell"
  cell_annotation[leiden_1_100 == "12"] = "Myeloid Cell"
  cell_annotation[leiden_1_100 == "13"] = "Melanocyte"
  #
  ...
  ###
  py_run_string("adata_imbalance.obs['leiden_1'] = adata_imbalance.obs['leiden_1_100']")
